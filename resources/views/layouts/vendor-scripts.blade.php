...
<script src="{{ url('/assets/libs/select/dist/js/select2.min.js') }}"></script>
<script src="{{ url('/assets/js/circle-progress.js')  }}"></script>
...
<!-- Custom Js -->
<script src="{{ url('/assets/js/customs/dashboard.js') }}"></script>
