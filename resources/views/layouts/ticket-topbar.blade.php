<header id="page-topbar" style="left: 0px !important ">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="@if (Auth::user()->avatar != ''){{ URL::asset('public/storage/' . Auth::user()->avatar) }}@else{{ URL::asset('public/assets/images/users/user-dummy-img.jpg') }}@endif"
                                alt="Header Avatar">
