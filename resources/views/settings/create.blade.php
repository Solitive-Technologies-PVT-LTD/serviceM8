        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form class="needs-validation @if (count($errors) > 0) was-validated @endif" action="{{url('/roles-management/role-store')}}" enctype="multipart/form-data" method="POST" novalidate>
                        @csrf
                        <div class="form-row">
