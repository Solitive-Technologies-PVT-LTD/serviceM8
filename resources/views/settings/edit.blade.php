        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form class="needs-validation @if (count($errors) > 0) was-validated @endif" action="{{url('/roles-management/role-update/'.$role->id)}}" enctype="multipart/form-data" method="POST" novalidate>
                        @csrf
                        <div class="form-row">
                                ...
                                @foreach ($permissions as $permission)
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox mb-3">
                                                ...
                                                @else
                                                    <input class="custom-control-input" id="permission-{{$permission->id}}" name="permission[]" type="checkbox" value="{{$permission->id}}">
                                                @endif
