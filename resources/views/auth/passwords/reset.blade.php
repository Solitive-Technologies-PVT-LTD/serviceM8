                            ...
                            <div>
                                <a href="{{url('/')}}" class="d-inline-block auth-logo">
                                    @if(empty(get_setting('company_logo')))
                                        <img src="{{ url('/assets/images/khazanapk-logo.png') }}" alt="Logo" height="50" width="50">
                                    @else
                                        <img src="{{ url('/storage/'.get_setting('company_logo')) }}" alt="Logo" height="50" width="50">
                                    @endif
                                </a>
                            </div>
                        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Reset password with {{ get_setting('company_name') }}</p>
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">Wait, I remember my password... <a href="{{url('/')}}"
