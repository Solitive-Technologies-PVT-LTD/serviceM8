...
<?php $__env->startSection('header-action'); ?>
    <a href="<?php echo e(route('dashboard')); ?>" class="border-2 border-toms-green text-toms-green hover:bg-toms-green hover:text-white font-medium px-6 py-2 rounded transition">
        REQUEST QUOTE
    </a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel-app\resources\views/request-quote.blade.php ENDPATH**/ ?>