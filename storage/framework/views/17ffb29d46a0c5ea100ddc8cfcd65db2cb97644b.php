...
<!-- Theme Settings -->
<div class="offcanvas offcanvas-end border-0 sidebar_offcanvas" tabindex="1" id="theme-settings-offcanvas">
    <div class="d-flex align-items-center bg-primary bg-gradient p-3 offcanvas-header">
        <h5 class="m-0 me-2 text-white">Theme Customizer</h5>

        <button type="button" class="btn-close btn-close-white offcanvas_close ms-auto" data-bs-dismiss="offcanvas"
        ...
        <div data-simplebar class="h-100">
            <div class="p-4">
                ...
                <div id="layout-position">
                    ...
                    <p class="text-muted">Choose Fixed or Scrollable Layout Position of Topbar.</p>
...
<?php /**PATH C:\laragon\www\laravel-app\resources\views/layouts/customizer.blade.php ENDPATH**/ ?>