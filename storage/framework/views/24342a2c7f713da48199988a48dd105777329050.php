<?php $__env->startSection('title', 'Service Details - Tom\'s Pest Control'); ?>
...
<div class="max-w-4xl mx-auto">
        ...
        <div class="space-y-4">
            ...
            <div class="bg-white rounded-lg p-6 shadow flex items-center justify-between hover:shadow-md transition">
                <div class="flex items-center">
                    ...
                    <span class="text-lg font-medium text-gray-900"><?php echo e($document['name']); ?></span>
                </div>
    ...
    <div class="mt-12">
        ...
        <div class="overflow-x-auto pb-4 scrollbar-hide" style="scrollbar-width: none; -ms-overflow-style: none;">
            <div class="flex space-x-4" style="min-width: max-content;">
                ...
                <div class="relative group cursor-pointer flex-shrink-0" onclick="openPhotoModal(<?php echo e($index); ?>)">
    ...
    <div id="photoModal" class="fixed inset-0 bg-black bg-opacity-90 z-50 hidden flex items-center justify-center p-4">
        ...
        <div class="absolute bottom-4 left-1/2 transform -translate-x-1/2 text-white text-sm">
            <span id="photoCounter">1 / <?php echo e(count($photos)); ?></span>
        </div>
    </div>

    <script>
        const photos = <?php echo json_encode($photos, 15, 512) ?>;
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel-app\resources\views/service-detail.blade.php ENDPATH**/ ?>