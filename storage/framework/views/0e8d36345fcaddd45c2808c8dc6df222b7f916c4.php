    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Edit  Menu Item :<strong><?php echo e($menu->title); ?></strong> </h4>

            </div><!-- end card header -->
            <form method="post" action="<?php echo e(route('menus.update', $menu->id)); ?>"   enctype="multipart/form-data"> 
...
unset($__errorArgs, $__bag); ?>" name="title" value="<?php echo e(old('title', $menu->title)); ?>"/>
...
unset($__errorArgs, $__bag); ?>" name="display_name"  value="<?php echo e(old('display_name', $menu->display_name)); ?>"/>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row gy-4" >
                            <div class="col-lg-9  pt-2" >
                                    ...
                                    <select id="icon" class="select2 form-control <?php $__errorArgs = ['icon'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?> icons_select2" name="icon">
                                        <option value="">Select</option>
                                        <?php $__currentLoopData = $icons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $icon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($icon->name); ?>" data-icon="mdi-<?php echo e($icon->name); ?>" <?php if( $icon->name == $menu->icon ): ?> selected <?php endif; ?>> <?php echo e(ucwords(str_replace("-", " ", $icon->name))); ?>  
                                            </option>
...
unset($__errorArgs, $__bag); ?>" name="parent_id">
                                        ...
                                        <?php $__currentLoopData = $all_menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($menu_item->id); ?>" <?php if(old('parent_id', $menu->parent_id) == $menu_item->id): ?> selected <?php endif; ?> data-icon="fa-<?php echo e($menu_item->icon); ?>"><?php echo e($menu_item->title); ?> </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
...
unset($__errorArgs, $__bag); ?>" name="route_name">
                                    <option value="">Select</option>
                                    <option value="#" <?php if(old('route_name', $menu->route_name) == '#'): ?> selected <?php endif; ?>># [Not Applicable]</option>
                                    <?php $__currentLoopData = $all_routes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($route->getName() != ""): ?>
                                            <option value="<?php echo e($route->getName()); ?>" <?php if(old('route_name', $menu->route_name) == $route->getName()): ?> selected <?php endif; ?>><?php echo e($route->getName()); ?> [<?php echo e($route->uri()); ?>]</option>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
...
unset($__errorArgs, $__bag); ?>" name="permission">
                                    ...
                                    <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($permission->id); ?>" <?php if(old('permission', $menu->permission) == $permission->id): ?> selected <?php endif; ?>><?php echo e($permission->name); ?> [<?php echo e($permission->id); ?>]</option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
...
unset($__errorArgs, $__bag); ?>" name="active">
                                    <option value="">Select</option>
                                    <option value="0" <?php if(old('active', $menu->active) == 0): ?> selected <?php endif; ?>>No</option>
                                    <option value="1" <?php if(old('active', $menu->active) == 1): ?> selected <?php endif; ?>>Yes</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" name="description"> <?php echo e(old('description', $menu->description)); ?></textarea>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\serviceM8\resources\views/menus/edit.blade.php ENDPATH**/ ?>