            ...
            <?php
                ...
                ?>
                    ...
                    <div class="row">
                        ...
                        <?php if($user->can('setting-create') ||  $isSuperAdmin): ?>      
    ...
    <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form method="post" action="<?php echo e(route('setting-save')); ?>" name="add-setting-form" id="add-setting-form" enctype="multipart/form-data"> 
                    <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        $(function() {
            var columns = [ 0,1,2,3 ];
                ...
                ajax: '<?php echo url('/settings/setting-ajax-data'); ?>',
        ...
        headers: {
          'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
           ...
           $.ajax({
        url: "<?php echo e(route('get-settings-data')); ?>",
        type : "POST",
        data : {
        ...
        success:function(settings){
           // alert("testing");
                ...
                $("#settings_img").attr('src',"<?php echo e(asset('storage')); ?>/"+settings.value);c
                //$("#add-btn").text("Update");
      ...
      /*
        ...
        if(settings.type == "text")
        {
                ...
                $("#text_value").addClass("d-none")
                $('#settings_img').removeClass("d-none");
                $("#settings_img").attr('src',"<?php echo e(asset('public/storage')); ?>/"+settings.value);
        }   
        */
    }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel-app\resources\views/settings/index.blade.php ENDPATH**/ ?>