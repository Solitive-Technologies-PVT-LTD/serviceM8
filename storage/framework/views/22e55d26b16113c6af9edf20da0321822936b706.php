    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
        ...
        <div class="mb-4">
            <nav class="flex items-center space-x-2 text-sm">
                <a href="<?php echo e(route('documents.index')); ?>" class="text-toms-green hover:underline">Home</a>
                <?php if($breadcrumb): ?>
                    <?php $__currentLoopData = $breadcrumb; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $folder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <a href="<?php echo e(route('documents.index', $folder->id)); ?>" class="text-toms-green hover:underline"><?php echo e($folder->name); ?></a>
            ...
            <div id="gridView" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                <?php $__empty_1 = true; $__currentLoopData = $folders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $folder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="p-4 bg-white shadow hover:shadow-lg rounded-lg flex flex-col items-center transition-transform transform hover:-translate-y-1">
                        <a href="<?php echo e(route('documents.index', $folder->id)); ?>" class="flex flex-col items-center text-center">
                        ...
                        <?php $__currentLoopData = $folders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $folder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 transition">
                                <td class="px-6 py-4 flex items-center space-x-3">
                                    ...
                                    <a href="<?php echo e(route('documents.index', $folder->id)); ?>" class="text-gray-900 font-medium"><?php echo e($folder->name); ?></a>
                                </td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel-app\resources\views/documents/index.blade.php ENDPATH**/ ?>